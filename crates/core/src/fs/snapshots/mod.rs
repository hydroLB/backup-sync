...
/// Make it explicit whether a version was derived from a live filesystem view or a snapshot view.
...
/// Scanning and reading blobs must use the same consistent view to avoid mismatched manifests.
#[derive(Debug)]
...
/// Prepare a best-effort snapshot-backed view of a watched path.
